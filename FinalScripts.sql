...
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'APPLE', @STOCKPRICE = 100.894, @TICKERSYMBOL = 'AAPL' 
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'MICROSOFT', @STOCKPRICE = 105.455, @TICKERSYMBOL = 'MSFT' 
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'Tesla Inc', @STOCKPRICE = 895.43, @TICKERSYMBOL = 'TSLA' 
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'Alphabet Inc', @STOCKPRICE = 119.122, @TICKERSYMBOL = 'GOOG' 
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'NVIDIA Corp', @STOCKPRICE = 189.89, @TICKERSYMBOL = 'NVDA' 
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'Meta Platforms Inc', @STOCKPRICE = 160.0, @TICKERSYMBOL = 'META' 
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'PepsiCo Inc', @STOCKPRICE = 179.455, @TICKERSYMBOL = 'PEP'
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'Adobe Inc', @STOCKPRICE = 417.78, @TICKERSYMBOL = 'ADBE'
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'Cisco Systems Inc', @STOCKPRICE = 47.45, @TICKERSYMBOL = 'CSCO'
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'Analog Devices Inc', @STOCKPRICE = 120.8500, @TICKERSYMBOL = 'ADI'
EXEC dbo.ADDSTOCKS @USERNAME='admin', @PASSWORD = 'admin',@STOCKNAME = 'CSX Corp', @STOCKPRICE = 25.500, @TICKERSYMBOL = 'CSX'
